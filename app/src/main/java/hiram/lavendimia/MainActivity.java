...
import hiram.lavendimia.fragments.ArticlesFragment;
import hiram.lavendimia.fragments.ClientsFragment;
import hiram.lavendimia.fragments.ConfigurationFragment;
import hiram.lavendimia.fragments.SalesFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle( this, drawerLayout,
                null, R.string.open_nav_drawer, R.string.close_nav_drawer);
